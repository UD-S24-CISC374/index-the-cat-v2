...
export default class Cat extends Phaser.GameObjects.Container {
    ...
    /** The start symbol */
    private startSymbol: Phaser.GameObjects.Text;
    /** The end symbol */
    private endSymbol: Phaser.GameObjects.Text;
    ...
    constructor(scene: Phaser.Scene, x: number, y: number) {
        ...
        this.catHead = scene.add
            .image(0, 0, "cat-head-neutral")
            .setScale(0.5, 0.5)
            .setOrigin(1, 1);
        this.catTail = scene.add
            .image(0, 0, "cat-tail")
            .setScale(0.5, 0.5)
            .setOrigin(0, 1);
        this.catMiddle = scene.add
            .tileSprite(0, 0, 0, 0, "cat-middle")
            .setScale(0.5, 0.5);

        this.startSymbol = scene.add
            .text(0, 0, "[")
            .setStyle(DEFAULT_FONT_SETTINGS)
            .setOrigin(0.5, 0.5);
        this.endSymbol = scene.add
            .text(0, 0, "]")
            .setStyle(DEFAULT_FONT_SETTINGS)
            .setOrigin(0.5, 0.5);
     ...
     */
    updateCatBodyPosition(catBodyCount: number, wrapSymbols: string = "") {
        ...
        this.startSymbol.setPosition(-catWidth / 4, this.CAT_BODY_OFFSET);
        this.endSymbol.setPosition(catWidth / 4, this.CAT_BODY_OFFSET);
        this.startSymbol.setText(wrapSymbols[0]);
        this.endSymbol.setText(wrapSymbols[1]);
