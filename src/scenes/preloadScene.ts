...
export default class PreloadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image(
            "cat-head-neutral",
            "assets/img/cat/cat_head_neutral.png"
        );
        ...
        // Cat SFX
        this.load.audio("cat-angry", [
            "assets/audio/cat-angry.mp3",
            "assets/audio/cat-angry.ogg",
        ]);
        this.load.audio("cat-happy", [
            "assets/audio/cat-happy.mp3",
            "assets/audio/cat-happy.ogg",
        ]);
